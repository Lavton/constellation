...
<body>
  ...
  <div id="page-container">
    ...
    <div ng-cloak ng-controller="CSeventsApp" id="cs-events">
      ...
      <!-- добавление/редактирование базовых мероприятий -->
...
<button type="button" ng-click="editEventSubmit()" ng-show="edit_ev && newevent.name" class="btn btn-success">Сохранить</button>
<br>
