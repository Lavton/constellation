  ...
  function init_angular_o_cand_c ($scope, $http, $locale) {
    ...
    $(".user-info").removeClass("hidden")
     var inthrefID = setInterval(function(){
      ...
      if (userid != "candidats") {
        ...
        var data = {action: "get_one_candidate_info", id: userid}
        // debugger;
    ...
    $scope.killCandidate = function() {
      ...
      if (confirm("Точно удалить профиль?")) {
        var data = {action: "kill_candidate", id: userid}
    ...
    function get_vk(callback) {
      var data_vk = {user_ids: $scope.candidate.domain, fields: ["photo_200", "domain"]}
