...
<p>
Идея создания сайта возникла весной 2014, когда я готовился стать методистом. (К слову, выборы проиграл и так им и не стал)<br/>
...
Плюс сыграло роль знакомство с  <a href="https://grails.org/" target="_blank">Grails</a> летом 2014. (хотя он и не используется тут сейчас) и в принципе с веб-технологиями. <br/>
...
И вот, закончив её, под новый год 2015 появились первые шаги для сайта!<br/>
