...
<hr>
Перед всем этим... В этом блоке комментов я буду писать про маленькие изменения, которые, с одной стороны,
всё же были, но с другой - слишком малы для поста на стене группы.
...
VK.Widgets.Comments("vk_comments", {limit: 40, width: "665", attach: "*", autoPublish: "0"}, 901231231);
</script>
</div>
