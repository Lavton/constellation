...
<p>Я - <a href="vk.com/lavton" target="_blank">Антон Лиознов</a>, боец СПО Созвездия 2012 набора, уже старик на данным момент.
Если вас интересуют более подробные вещи, связанные с сайтом или же с интелект-картами в методическом отделе (пока их нет, но скоро будут) - пишите!</p>
<p>
...
Ну и, кроме того, летом вместо лагеря работал разработчиком, освоив в некоторой мере <a href="https://grails.org/" target="_blank">Grails</a> (хотя он и не используется тут сейчас) и в принципе начав знакомство с веб-технологиями. <br/>
...
Ну и <a href="http://habrahabr.ru/post/154617/" target="_blank">навигация</a> тоже чисто на jquery
</p>
