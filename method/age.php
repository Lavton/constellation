...
<body>
  ...
  <div id="page-container">
    ...
    <?php /*смотрим всех*/ if ((isset($_SESSION[ "current_group"]) && ($_SESSION[ "current_group"]>= OLD_FIGHTER))) { ?>
    <hr> (для стариков, экс- и нынешнего комсостава, поток мыслей, которые я почерпнул из Аверена, книги по возрастной психологии)
    <br> Хочется систематизации и интеллект-карты))
