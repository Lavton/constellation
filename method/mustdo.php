...
<body>
  ...
  <div id="page-container">
    ...
    <ul>
      ...
      <details> Адрес:  <br>
Литейный проспект, дом 6. Вход с улицы Чайковского, третий подъезд, там прям на двери всё про приём заявлений написано<br>
Часы Работы: <br>
...
<br>
С собой иметь паспорт, копию паспорта (со всеми страницами с записью), заявление заполняется на месте.
<br><br>
ИЛИ в своём районе в <a href="https://gu.spb.ru/mfc/list/">МФЦ</a>, справка делается 12 дней
      </details>
...
VK.Widgets.Like("vk_like", {type: "fill"},78156452)
</script>
<script type="text/javascript">
VK.Widgets.Comments("vk_comments", {limit: 10, width: "665", attach: "*", autoPublish: "0"}, 78156452);
</script>
