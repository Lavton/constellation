...
<body>
  ...
  <div id="page-container">
    <p>Данная страница помогает сохранить данетки с сайте <a href="http://www.danetka.ru/">danetka.ru</a> в удобном для вожатых формате, а именно списком с вопросами-ответами.
